...
class TestMerging:
    def test_two_independent_boxes(self, merge_function) -> None:
    ...
    def test_two_overlapping_boxes(self, merge_function) -> None:
    ...
    def test_three_overlapping_boxes_1(self, merge_function) -> None:
    ...
    def test_three_overlapping_boxes_2(self, merge_function) -> None:
        boxes = [
            Box([1, 16, 17, 10, 10]),
            Box([1, 16, 15, 10, 10]),
            Box([1, 16, 16, 10, 10]),
    ...
    def test_four_recursively_overlapping_boxes(self, merge_function) -> None:
        boxes = [
            Box([1, 4, 16, 4, 22]),
            Box([1, 9, 6, 10, 4]),
            Box([1, 14, 3, 4, 4]),
